    ...
    implements BlockCipher
{
     ...
     *                      {@link #BLOCKSIZE_1024}.
     */
    public ThreefishEngine(final int blocksizeBits, long rounds)
    {
        ...
        if (rounds % 4 != 0) {
            throw new IllegalArgumentException("Wrong rounds number " + rounds);
        }

        switch (blocksizeBits)
        {
        case BLOCKSIZE_256:
            cipher = new ThreefishEngine.Threefish256Cipher(kw, t, rounds);
            break;
        case BLOCKSIZE_512:
            cipher = new ThreefishEngine.Threefish512Cipher(kw, t, rounds);
            break;
        case BLOCKSIZE_1024:
            cipher = new ThreefishEngine.Threefish1024Cipher(kw, t, rounds);
            break;
        default:
        ...
        extends ThreefishEngine.ThreefishCipher
    {
        ...
        public Threefish256Cipher(long[] kw, long[] t, long rounds)
        {
            super(kw, t);
            this.rounds = rounds;
        }
        ...
        void encryptBlock(long[] block, long[] out)
        {
            ...
            for (long d = 1; d < (rounds / 4); d += 2)
            {
                final int dm5 = (int) (d % 5);
                final int dm3 = (int) (d % 3);
        ...
        extends ThreefishEngine.ThreefishCipher
    {
        ...
        protected Threefish512Cipher(long[] kw, long[] t, long rounds)
        {
            super(kw, t);
            this.rounds = rounds;
        }
        ...
        extends ThreefishEngine.ThreefishCipher
    {
        ...
        public Threefish1024Cipher(long[] kw, long[] t, long rounds)
        {
            super(kw, t);
            this.rounds = rounds;
        }
