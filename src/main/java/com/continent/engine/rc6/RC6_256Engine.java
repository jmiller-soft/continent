    ...
    implements BlockCipher
{
    ...
    private static final int    LGW = 6;        // log2(64)
     ...
     */
    public RC6_256Engine()
    {
        this(20);
    }
    
    public RC6_256Engine(int rounds)
    {
        _S            = null;
        _noRounds = rounds;
    }
        ...
        int     outOff)
    {
        ...
        long C = bytesToWord(in, inOff + bytesPerWord*2);
        long D = bytesToWord(in, inOff + bytesPerWord*3);
